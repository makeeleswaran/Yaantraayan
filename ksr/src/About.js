...
<Card className="text-center"style={{backgroundColor:"#013"}} data-aos="fade-up"   data-aos-duration="2000">
      <Card.Header  style={{backgroundColor:"#014587",marginTop:"0px",color:"white",fontSize:"20px",height:"70px",display:"flex",alignItems:"center",justifyContent:"center"}}>Our College</Card.Header>
...
Tiruchengode - 637 215 
      ...
      <Card.Footer  style={{backgroundColor:"#014587",color:"green",fontSize:"20px"}} className="text-muted">Thank You</Card.Footer>
    </Card>
    </div>
     </div>
  )
